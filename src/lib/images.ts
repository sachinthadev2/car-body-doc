...
export const showcase: ShowcaseItem[] = [
  { src: "/gallery/showcase-1.jpg", alt: "Panel technician repairing a bumper", span: "col-span-1 row-span-2" },
  { src: "/gallery/showcase-2.jpg", alt: "Detailing a repaired sports car", span: "col-span-1 row-span-2" },
  { src: "/gallery/showcase-3.jpg", alt: "Machine polishing dark paintwork", span: "col-span-2 row-span-2" },
  { src: "/gallery/showcase-4.jpg", alt: "Spray painting a panel on site", span: "col-span-1 row-span-3" },
  { src: "/gallery/showcase-5.jpg", alt: "Cutting and polishing a finished panel", span: "col-span-1 row-span-2" },
  { src: "/gallery/showcase-6.jpg", alt: "Close up of a colour matched respray", span: "col-span-1 row-span-3" },
  { src: "/gallery/showcase-7.jpg", alt: "Masked up vehicle ready for paint", span: "col-span-1 row-span-2" },
  { src: "/gallery/showcase-8.jpg", alt: "Final wipe down after a repair", span: "col-span-2 row-span-2" },
  { src: "/gallery/showcase-9.jpg", alt: "Hands on the tools in the mobile workshop", span: "col-span-1 row-span-2" },
];
